...
int InjectionDllCaller() {
	...
	auto WhitelistPage = [](uintptr_t page) {
		...
		uintptr_t offset_SetInsert = 0xCAA3F0; // updated
		uintptr_t offset_WhitelistedPages = 0x2B92E0; // updated
		uintptr_t offset_Bitmap = 0x2A2370; // updated
		uintptr_t pageHash = 0x3DC80039; // updated
		uintptr_t byteHash = 0x79; // updated
